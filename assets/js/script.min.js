! function (e, t) {
    ...
    var h = function (n) {
        ...
        var e, f, b, r, s, h, p, v, x, l, c, k, T, a, S, g, d, y, m, C = "sizzle" + 1 * new Date,
            w = n.document,
            $ = 0,
            i = 0,
            A = le(),
        ...
        function ae(t, e, n, i) {
            ...
            if (!i && ((e ? e.ownerDocument || e : w) !== T && k(e), e = e || T, S)) {
                if (11 !== p && (l = te.exec(t)))
                    if (o = l[1]) {
                        if (9 === p) {
                        ...
                        if ((o = l[3]) && f.getElementsByClassName && e.getElementsByClassName) return O.apply(n, e.getElementsByClassName(o)), n
                    } if (f.qsa && !j[t + " "] && (!g || !g.test(t)) && (1 !== p || "object" !== e.nodeName.toLowerCase())) {
                    if (d = t, u = e, 1 === p && Y.test(t)) {
        ...
        for (e in f = ae.support = {}, s = ae.isXML = function (e) {
                ...
                return i !== T && 9 === i.nodeType && i.documentElement && (a = (T = i).documentElement, S = !s(T), w !== T && (n = T.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", o, !1) : n.attachEvent && n.attachEvent("onunload", o)), f.attributes = de(function (e) {
                    ...
                    f.disconnectedMatch = y.call(e, "*"), y.call(e, "[s!='']:x"), d.push("!=", F)
                    ...
                    return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !f.sortDetached && t.compareDocumentPosition(e) === n ? e === T || e.ownerDocument === w && m(w, e) ? -1 : t === T || t.ownerDocument === w && m(w, t) ? 1 : l ? M(l, e) - M(l, t) : 0 : 4 & n ? -1 : 1)
                } : function (e, t) {
                    if (e === t) return c = !0, 0;
                    var n, i = 0,
                        o = e.parentNode,
                ...
                if ((e.ownerDocument || e) !== T && k(e), f.matchesSelector && S && !j[t + " "] && (!d || !d.test(t)) && (!g || !g.test(t))) try {
                    var n = y.call(e, t);
                ...
                pseudos: {
                    ...
                    lang: ce(function (n) {
                        return G.test(n || "") || ae.error("unsupported lang: " + n), n = n.replace(ie, u).toLowerCase(),
                            function (e) {
                                var t;
                                do {
        ...
        function Te(f, h, v, g, y, e) {
            return g && !g[C] && (g = Te(g)), y && !y[C] && (y = Te(y, e)), ce(function (e, t, n, i) {
                var o, r, s, a = [],
                    l = [],
                    c = t.length,
                    d = e || function (e, t, n) {
                ...
                } else p = ke(p === t ? p.splice(c, p.length) : p), y ? y(null, t, p, i) : O.apply(t, p)
            })
        }
        ...
        function Ce(g, y) {
            function e(e, t, n, i, o) {
                ...
                if (l += c, m && c !== l) {
                    ...
                    O.apply(i, u), o && !e && 0 < u.length && 1 < l + y.length && ae.uniqueSort(i)
                }
                return o && ($ = h, x = p), d
            }
            var m = 0 < y.length,
        ...
        return me.prototype = b.filters = b.pseudos, b.setFilters = new me, h = ae.tokenize = function (e, t) {
            ...
            for (s = e, a = [], l = b.preFilter; s;) {
                for (r in n && !(i = U.exec(s)) || (i && (s = s.slice(i[0].length) || s), a.push(o = [])), n = !1, (i = X.exec(s)) && (n = i.shift(), o.push({
                        value: n,
                        type: i[0].replace(B, " ")
                    }), s = s.slice(n.length)), b.filter) !(i = Q[r].exec(s)) || l[r] && !(i = l[r](i)) || (n = i.shift(), o.push({
                    value: n,
                    type: r,
                    matches: i
                }), s = s.slice(n.length));
            ...
            var n, i = [],
                ...
                r = D[e + " "];
            if (!r) {
                for (n = (t = t || h(e)).length; n--;)(r = Se(t[n]))[C] ? i.push(r) : o.push(r);
            ...
            if (n = n || [], 1 === d.length) {
                ...
                for (o = Q.needsContext.test(e) ? 0 : r.length; o-- && (s = r[o], !b.relative[a = s.type]);)
                    if ((l = b.find[a]) && (i = l(s.matches[0].replace(ie, u), ne.test(r[0].type) && ye(t.parentNode) || t))) {
                        if (r.splice(o, 1), !(e = i.length && we(r))) return O.apply(n, i), n;
                        break
                    }
            }
            return (c || p(e, d))(i, t, !S, n, !t || ne.test(e) && ye(t.parentNode) || t), n
        }, f.sortStable = C.split("").sort(L).join("") === C, f.detectDuplicates = !!c, k(), f.sortDetached = de(function (e) {
    ...
    (C.fn.init = function (e, t, n) {
        var i, o;
        if (!e) return this;
        if (n = n || L, "string" != typeof e) return e.nodeType ? (this[0] = e, this.length = 1, this) : w(e) ? void 0 !== n.ready ? n.ready(e) : e(C) : C.makeArray(e, this);
    ...
    C.fn.extend({
        ...
        C.fn[i] = function (e, t) {
            ...
            return "Until" !== i.slice(-5) && (t = e), t && "string" == typeof t && (n = C.filter(t, n)), 1 < this.length && (q[i] || C.uniqueSort(n), H.test(i) && n.reverse()), this.pushStack(n)
        }
    });
    var P = /[^\x20\t\r\n\f]+/g;
                ...
                s = {
                    ...
                    then: function (t, n, i) {
                            ...
                            return function () {
                                function e() {
                                    ...
                                    if (!(o < l)) {
                                        ...
                                        t = e && ("object" == typeof e || "function" == typeof e) && e.then, w(t) ? a ? t.call(e, c(l, r, M, a), c(l, r, I, a)) : (l++, t.call(e, c(l, r, M, a), c(l, r, I, a), c(l, r, M, r.notifyWith))) : (s !== M && (n = void 0, i = [e]), (a || r.resolveWith)(n, i))
                                    }
                                }
                                var n = this,
                                    i = arguments,
                        ...
                        return C.Deferred(function (e) {
                            r[0][3].add(c(0, e, w(i) ? i : M, e.notifyWith)), r[1][3].add(c(0, e, w(t) ? t : M)), r[2][3].add(c(0, e, w(n) ? n : I))
                        }).promise()
                    },
                    promise: function (e) {
    ...
    }), C.ready.then = W.then, "complete" === S.readyState || "loading" !== S.readyState && !S.documentElement.doScroll ? T.setTimeout(C.ready) : (S.addEventListener("DOMContentLoaded", F), T.addEventListener("load", F));
    ...
    function xe(e, t, n, i, o) {
        for (var r, s, a, l, c, d, u = t.createDocumentFragment(), p = [], f = 0, h = e.length; f < h; f++)
            ...
            for (s = s || u.appendChild(t.createElement("div")), a = (fe.exec(r) || ["", ""])[1].toLowerCase(), l = ve[a] || ve._default, s.innerHTML = l[1] + C.htmlPrefilter(r) + l[2], d = l[0]; d--;) s = s.lastChild;
    ...
    me = S.createDocumentFragment().appendChild(S.createElement("div")), (we = S.createElement("input")).setAttribute("type", "radio"), we.setAttribute("checked", "checked"), we.setAttribute("name", "t"), me.appendChild(we), m.checkClone = me.cloneNode(!0).cloneNode(!0).lastChild.checked, me.innerHTML = "<textarea>x</textarea>", m.noCloneChecked = !!me.cloneNode(!0).lastChild.defaultValue;
    var ke = /^key/,
    ...
    C.event = {
        ...
        add: function (t, e, n, i, o) {
            ...
            if (g)
                for (n.handler && (n = (r = n).handler, o = r.selector), o && C.find.matchesSelector(oe, o), n.guid || (n.guid = C.guid++), (l = g.events) || (l = g.events = {}), (s = g.handle) || (s = g.handle = function (e) {
                        return void 0 !== C && C.event.triggered !== e.type ? C.event.dispatch.apply(t, arguments) : void 0
                    }), c = (e = (e || "").match(P) || [""]).length; c--;) f = v = (a = Se.exec(e[c]) || [])[1], h = (a[2] || "").split(".").sort(), f && (u = C.event.special[f] || {}, f = (o ? u.delegateType : u.bindType) || f, u = C.event.special[f] || {}, d = C.extend({
                    type: f,
                    origType: v,
                    data: i,
                    handler: n,
    ...
    function Ie(n, i, o, r) {
        ...
        var e, t, s, a, l, c, d = 0,
            ...
            f = i[0],
            h = w(f);
        if (h || 1 < u && "string" == typeof f && !m.checkClone && Ne.test(f)) return n.each(function (e) {
            var t = n.eq(e);
            h && (i[0] = f.call(this, e, t.html())), Ie(t, i, o, r)
        });
        if (u && (t = (e = xe(i, n[0].ownerDocument, !1, n, r)).firstChild, 1 === e.childNodes.length && (e = t), t || r)) {
            for (a = (s = C.map(ge(e, "script"), Oe)).length; d < u; d++) l = e, d !== p && (l = C.clone(l, !0, !0), a && C.merge(s, ge(l, "script"))), o.call(n[d], l, d);
            if (a)
                for (c = s[s.length - 1].ownerDocument, C.map(s, Pe), d = 0; d < a; d++) l = s[d], he.test(l.type || "") && !Q.access(l, "globalEval") && C.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, {
                    nonce: l.nonce || l.getAttribute("nonce")
                }) : b(l.textContent.replace(He, ""), l, c))
        }
        return n
    }

    function ze(e, t, n) {
        for (var i, o = t ? C.filter(t, e) : e, r = 0; null != (i = o[r]); r++) n || 1 !== i.nodeType || C.cleanData(ge(i)), i.parentNode && (n && re(i) && ye(ge(i, "script")), i.parentNode.removeChild(i));
        return e
    }
    C.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (!(m.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || C.isXMLDoc(e)))
                for (s = ge(d), i = 0, o = (r = ge(e)).length; i < o; i++) a = r[i], l = s[i], "input" === (c = l.nodeName.toLowerCase()) && pe.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
            if (t)
                if (n)
    ...
    var Re, We, Fe, _e, Be, Ue, Xe, Ye = new RegExp("^(" + te + ")(?!px)[a-z%]+$", "i"),
        Ve = function (e) {
    ...
    function Qe() {
        if (Xe) {
            ...
            Re = "1%" !== e.top, Be = 12 === Je(e.marginLeft), Xe.style.right = "60%", _e = 36 === Je(e.right), We = 36 === Je(e.width), Xe.style.position = "absolute", Fe = 12 === Je(Xe.offsetWidth / 3), oe.removeChild(Ue), Xe = null
        }
    }
    ...
    function Ke(e, t, n) {
        ...
        return (n = n || Ve(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || re(e) || (s = C.style(e, t)), !m.pixelBoxStyles() && Ye.test(s) && Ge.test(t) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
    }
    ...
    Ue = S.createElement("div"), (Xe = S.createElement("div")).style && (Xe.style.backgroundClip = "content-box", Xe.cloneNode(!0).style.backgroundClip = "", m.clearCloneStyle = "content-box" === Xe.style.backgroundClip, C.extend(m, {
    ...
    function dt(e, t, n) {
        ...
        return (!m.boxSizingReliable() && o || "auto" === s || !parseFloat(s) && "inline" === C.css(e, "display", !1, i)) && e.getClientRects().length && (o = "border-box" === C.css(e, "boxSizing", !1, i), (r = a in e) && (s = e[a])), (s = parseFloat(s) || 0) + ct(e, t, n || (o ? "border" : "content"), r, i, s) + "px"
    }
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, r, s, a = Y(t),
                    l = rt.test(t),
                    c = e.style;
                if (l || (t = it(a)), s = C.cssHooks[t] || C.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (o = s.get(e, !1, i)) ? o : c[t];
                "string" === (r = typeof n) && (o = ne.exec(n)) && o[1] && (n = ce(e, t, o), r = "number"), null != n && n == n && ("number" !== r || l || (n += o && o[3] || (C.cssNumber[a] ? "" : "px")), m.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n))
            }
        },
        css: function (e, t, n, i) {
            var o, r, s, a = Y(t);
            return rt.test(t) || (t = it(a)), (s = C.cssHooks[t] || C.cssHooks[a]) && "get" in s && (o = s.get(e, !0, n)), void 0 === o && (o = Ke(e, t, i)), "normal" === o && t in at && (o = at[t]), "" === n || n ? (r = parseFloat(o), !0 === n || isFinite(r) ? r || 0 : o) : o
        }
    }), C.each(["height", "width"], function (e, l) {
        C.cssHooks[l] = {
            get: function (e, t, n) {
                if (t) return !ot.test(C.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? dt(e, l, n) : ae(e, st, function () {
                    return dt(e, l, n)
                })
            },
            set: function (e, t, n) {
                var i, o = Ve(e),
                    ...
                    a = n ? ct(e, l, n, s, o) : 0;
                return s && r && (a -= Math.ceil(e["offset" + l[0].toUpperCase() + l.slice(1)] - parseFloat(o[l]) - ct(e, l, "border", !1, o) - .5)), a && (i = ne.exec(t)) && "px" !== (i[3] || "px") && (e.style[l] = t, t = C.css(e, l)), lt(0, t, a)
            }
        }
        ...
        css: function (e, t) {
            return _(this, function (e, t, n) {
                var i, o, r = {},
                    s = 0;
                if (Array.isArray(t)) {
                    for (i = Ve(e), o = t.length; s < o; s++) r[t[s]] = C.css(e, t[s], !1, i);
                    return r
                }
    ...
    function mt() {
        ft && (!1 === S.hidden && T.requestAnimationFrame ? T.requestAnimationFrame(mt) : T.setTimeout(mt, C.fx.interval), C.fx.tick())
    }
    ...
    function kt(r, e, t) {
        ...
        for (! function (e, t) {
            ...
            if (n = kt.prefilters[i].call(c, r, d, c.opts)) return w(n.stop) && (C._queueHooks(c.elem, c.opts.queue).stop = n.stop.bind(n)), n;
        return C.map(d, xt, c), w(c.opts.start) && c.opts.start.call(r, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), C.fx.timer(C.extend(l, {
            elem: r,
            anim: c,
            queue: c.opts.queue
        })), c
    ...
    C.Animation = C.extend(kt, {
        ...
        tweener: function (e, t) {
            for (var n, i = 0, o = (e = w(e) ? (t = e, ["*"]) : e.match(P)).length; i < o; i++) n = e[i], kt.tweeners[n] = kt.tweeners[n] || [], kt.tweeners[n].unshift(t)
        },
        prefilters: [function (e, t, n) {
            ...
            for (i in n.queue || (null == (s = C._queueHooks(e, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function () {
                ...
                for (i in u && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (c = g && g.display) && (c = Q.get(e, "display")), "none" === (d = C.css(e, "display")) && (c ? d = c : (ue([e], !0), c = e.style.display || c, d = C.css(e, "display"), ue([e]))), ("inline" === d || "inline-block" === d && null != c) && "none" === C.css(e, "float") && (l || (p.done(function () {
                        h.display = c
                    ...
                    for (i in v || ue([e]), Q.remove(e, "fxshow"), f) C.style(e, i, f[i])
    ...
    }, ht = S.createElement("input"), vt = S.createElement("select").appendChild(S.createElement("option")), ht.type = "checkbox", m.checkOn = "" !== ht.value, m.optSelected = vt.selected, (ht = S.createElement("input")).value = "t", ht.type = "radio", m.radioValue = "t" === ht.value;
    var Tt, St = C.expr.attrHandle;
    C.fn.extend({
        attr: function (e, t) {
        ...
        attr: function (e, t, n) {
            ...
            if (3 !== r && 8 !== r && 2 !== r) return void 0 === e.getAttribute ? C.prop(e, t, n) : (1 === r && C.isXMLDoc(e) || (o = C.attrHooks[t.toLowerCase()] || (C.expr.match.bool.test(t) ? Tt : void 0)), void 0 !== n ? null === n ? void C.removeAttr(e, t) : o && "set" in o && void 0 !== (i = o.set(e, n, t)) ? i : (e.setAttribute(t, n + ""), n) : o && "get" in o && null !== (i = o.get(e, t)) ? i : null == (i = C.find.attr(e, t)) ? void 0 : i)
        },
        attrHooks: {
            type: {
                set: function (e, t) {
    ...
    C.fn.extend({
        ...
        toggleClass: function (o, t) {
            ...
            return "boolean" == typeof t && s ? t ? this.addClass(o) : this.removeClass(o) : w(o) ? this.each(function (e) {
                ...
                var e, t, n, i;
                if (s)
                    for (t = 0, n = C(this), i = Dt(o); e = i[t++];) n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
                else void 0 !== o && "boolean" != r || ((e = Et(this)) && Q.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === o ? "" : Q.get(this, "__className__") || ""))
            })
        },
        hasClass: function (e) {
            var t, n, i = 0;
            for (t = " " + e + " "; n = this[i++];)
                if (1 === n.nodeType && -1 < (" " + At(Et(n)) + " ").indexOf(t)) return !0;
            return !1
        }
    });
    var jt = /\r/g;
    C.fn.extend({
        val: function (n) {
            ...
            })) : t ? (i = C.valHooks[t.type] || C.valHooks[t.nodeName.toLowerCase()]) && "get" in i && void 0 !== (e = i.get(t, "value")) ? e : "string" == typeof (e = t.value) ? e.replace(jt, "") : null == e ? "" : e : void 0
        }
    }), C.extend({
        valHooks: {
            option: {
    ...
    C.extend(C.event, {
        trigger: function (e, t, n, i) {
            ...
            if (r = u = s = n = n || S, 3 !== n.nodeType && 8 !== n.nodeType && !Nt.test(f + C.event.triggered) && (-1 < f.indexOf(".") && (f = (h = f.split(".")).shift(), h.sort()), l = f.indexOf(":") < 0 && "on" + f, (e = e[C.expando] ? e : new C.Event(f, "object" == typeof e && e)).isTrigger = i ? 2 : 3, e.namespace = h.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : C.makeArray(t, [e]), d = C.event.special[f] || {}, i || !d.trigger || !1 !== d.trigger.apply(n, t))) {
                if (!i && !d.noBubble && !v(n)) {
                    for (a = d.delegateType || f, Nt.test(a + f) || (r = r.parentNode); r; r = r.parentNode) p.push(r), s = r;
                    s === (n.ownerDocument || S) && p.push(s.defaultView || s.parentWindow || T)
                }
                for (o = 0;
                    (r = p[o++]) && !e.isPropagationStopped();) u = r, e.type = 1 < o ? a : d.bindType || f, (c = (Q.get(r, "events") || {})[e.type] && Q.get(r, "handle")) && c.apply(r, t), (c = l && r[l]) && c.apply && V(r) && (e.result = c.apply(r, t), !1 === e.result && e.preventDefault());
                return e.type = f, i || e.isDefaultPrevented() || d._default && !1 !== d._default.apply(p.pop(), t) || !V(n) || l && w(n[f]) && !v(n) && ((s = n[l]) && (n[l] = null), C.event.triggered = f, e.isPropagationStopped() && u.addEventListener(f, Lt), n[f](), e.isPropagationStopped() && u.removeEventListener(f, Lt), C.event.triggered = void 0, s && (n[l] = s)), e.result
            }
        },
    ...
    Qt.href = Ht.href, C.extend({
        ...
        ajax: function (e, t) {
            ...
            if (w.promise(k), g.url = ((e || g.url || Ht.href) + "").replace(Xt, Ht.protocol + "//"), g.type = t.method || t.type || g.method || g.type, g.dataTypes = (g.dataType || "*").toLowerCase().match(P) || [""], null == g.crossDomain) {
                i = S.createElement("a");
                try {
            ...
            if (g.data && g.processData && "string" != typeof g.data && (g.data = C.param(g.data, g.traditional)), Kt(Yt, g, t, k), h) return k;
            for (o in (v = C.event && g.global) && 0 == C.active++ && C.event.trigger("ajaxStart"), g.type = g.type.toUpperCase(), g.hasContent = !Ut.test(g.type), u = g.url.replace(Ft, ""), g.hasContent ? g.data && g.processData && 0 === (g.contentType || "").indexOf("application/x-www-form-urlencoded") && (g.data = g.data.replace(Wt, "+")) : (r = g.url.slice(u.length), g.data && (g.processData || "string" == typeof g.data) && (u += (Ot.test(u) ? "&" : "?") + g.data, delete g.data), !1 === g.cache && (u = u.replace(_t, "$1"), r = (Ot.test(u) ? "&" : "?") + "_=" + qt++ + r), g.url = u + r), g.ifModified && (C.lastModified[u] && k.setRequestHeader("If-Modified-Since", C.lastModified[u]), C.etag[u] && k.setRequestHeader("If-None-Match", C.etag[u])), (g.data && g.hasContent && !1 !== g.contentType || t.contentType) && k.setRequestHeader("Content-Type", g.contentType), k.setRequestHeader("Accept", g.dataTypes[0] && g.accepts[g.dataTypes[0]] ? g.accepts[g.dataTypes[0]] + ("*" !== g.dataTypes[0] ? ", " + Gt + "; q=0.01" : "") : g.accepts["*"]), g.headers) k.setRequestHeader(o, g.headers[o]);
            if (g.beforeSend && (!1 === g.beforeSend.call(y, k, g) || h)) return k.abort();
            if (l = "abort", b.add(g.complete), k.done(g.success), k.fail(g.error), d = Kt(Vt, g, t, k)) {
    ...
    m.cors = !!tn && "withCredentials" in tn, m.ajax = tn = !!tn, C.ajaxTransport(function (o) {
        var r, s;
        if (m.cors || tn && !o.crossDomain) return {
            send: function (e, t) {
                var n, i = o.xhr();
    ...
    C.ajaxSetup({
        ...
        if (s || "jsonp" === e.dataTypes[0]) return i = e.jsonpCallback = w(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(rn, "$1" + i) : !1 !== e.jsonp && (e.url += (Ot.test(e.url) ? "&" : "?") + e.jsonp + "=" + i), e.converters["script json"] = function () {
            return r || C.error(i + " was not called"), r[0]
        }, e.dataTypes[0] = "json", o = T[i], T[i] = function () {
            r = arguments
        }, n.always(function () {
            void 0 === o ? C(T).removeProp(i) : T[i] = o, e[i] && (e.jsonpCallback = t.jsonpCallback, on.push(i)), r && w(o) && o(r[0]), r = o = void 0
        }), "script"
    }), m.createHTMLDocument = ((nn = S.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === nn.childNodes.length), C.parseHTML = function (e, t, n) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (m.createHTMLDocument ? ((i = (t = S.implementation.createHTMLDocument("")).createElement("base")).href = S.location.href, t.head.appendChild(i)) : t = S), r = !n && [], (o = D.exec(e)) ? [t.createElement(o[1])] : (o = xe([e], t, r), r && r.length && C(r).remove(), C.merge([], o.childNodes)));
        var i, o, r
    }, C.fn.load = function (e, t, n) {
        var i, o, r, s = this,
            a = e.indexOf(" ");
        return -1 < a && (i = At(e.slice(a)), e = e.slice(0, a)), w(t) ? (n = t, t = void 0) : t && "object" == typeof t && (o = "POST"), 0 < s.length && C.ajax({
            url: e,
            type: o || "GET",
            dataType: "html",
            data: t
        ...
        C.cssHooks[n] = Ze(m.pixelPosition, function (e, t) {
            if (t) return t = Ke(e, n), Ye.test(t) ? C(e).position()[n] + "px" : t
        })
    }), C.each({
        Height: "height",
        Width: "width"
    ...
    }, C.isArray = Array.isArray, C.parseJSON = JSON.parse, C.nodeName = E, C.isFunction = w, C.isWindow = v, C.camelCase = Y, C.type = x, C.now = Date.now, C.isNumeric = function (e) {
        var t = C.type(e);
    ...
    return C.noConflict = function (e) {
        return T.$ === C && (T.$ = an), e && T.jQuery === C && (T.jQuery = sn), C
    }, e || (T.jQuery = T.$ = C), C
}),
function (e) {
        ...
        2: [function (e, t, n) {
            ...
            o.prototype = {
                ...
                register: function (t, e, n) {
                    ...
                    return i[t] || (i[t] = new r(t, o)), a(e) && (e = {
                        match: e
...
function (e) {
    ...
    $sliderReviews = $(".reviews__slider"), $sliderReviews.slick({
        arrows: !1,
        dots: !0,
        slidesToShow: 1,
        slidesToScroll: 1,
        mobileFirst: !0
    }), $featuresSlider = $(".features__inner"), enquire.register("screen and (max-width: 767px)", {
        match: function () {
            $featuresSlider.hasClass("slick-initialized") || $featuresSlider.slick({
                arrows: !1,
                dots: !0,
                slidesToShow: 1,
                slidesToScroll: 1,
        ...
        unmatch: function () {
            $featuresSlider.hasClass("slick-initialized") && $featuresSlider.slick("unslick")
        }
    }), $(".reviews__slider-arrow-left").on("click", function (e) {
        e.preventDefault(), $sliderReviews.slick("slickPrev")
    }), $(".reviews__slider-arrow-right").on("click", function (e) {
        e.preventDefault(), $sliderReviews.slick("slickNext")
    })
}), document.querySelector(".hamburger").addEventListener("click", function () {
    document.querySelector(".hamburger").classList.toggle("is-active"), document.querySelector(".nav__link--active").classList.remove(".nav__link--active");
    for (var e = document.querySelectorAll(".nav__link"), t = 0; t < e.length; t++) e[t].classList.toggle("nav__link--visible")
}), $(document).ready(function () {
    // var e = window.location.pathname;
    // "/" !== e && ($(".nav__item").find("a").each(function () {
    //     $(this).toggleClass("nav__link--active", $(this).attr("href") == e)
    // }), console.log(e));
    var t = "zoomIn";
    $signin = $(".signin"), enquire.register("screen and (max-width: 767px)", {
        match: function () {
            console.log("test"), $($signin).addClass("mobile"), $signin.hasClass(t) && $signin.removeClass(t)
        },
        unmatch: function () {
            $($signin).removeClass("mobile"), $signin.hasClass(t) && $signin.removeClass(t)
        }
    }), enquire.register("screen and (min-width: 768px)", {
        match: function () {
            console.log("test1"), $signin.hasClass(t) && $signin.removeClass(t)
        }
    }), $(".nav__link--login").on("click", function (e) {
        e.preventDefault(), $signin.hasClass(t) && $signin.removeClass(t), $($signin).toggleClass("signin--visible"), $signin.hasClass("mobile") || $($signin).addClass(t), $(".nav__link").removeClass("nav__link--visible"), $(".hamburger").removeClass("is-active")
    }), $(".signin__close").on("click", function (e) {
        e.preventDefault(), $(".signin").removeClass("signin--visible")
    })
});